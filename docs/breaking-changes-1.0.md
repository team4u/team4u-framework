...
| 1.0 | Consumer gates are staged during convergence | Run consumer-it for the four currently green consumers; the config-core transition guard is explicit until Task 9. |
