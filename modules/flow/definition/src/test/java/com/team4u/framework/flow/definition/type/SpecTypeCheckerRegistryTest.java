...
public class SpecTypeCheckerRegistryTest {

    @Test
    public void testGlobalRegistryContainsAllSpecCheckers() {
        SpecTypeCheckerRegistry registry = SpecTypeCheckerRegistry.global();
    ...
    public void testFrozenCannotRegister() {
        SpecTypeCheckerRegistry registry = SpecTypeCheckerRegistry.global();
        registry.register(new SpecTypeCheckers.StepSpecTypeChecker());
    }
}
