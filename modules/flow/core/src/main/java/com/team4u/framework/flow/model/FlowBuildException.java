 ...
 * 聚合所有诊断问题 {@link Problem} 并一次性报告，便于开发者快速定位所有结构设计缺陷。
 * 直接继承 {@link RuntimeException}，不会被针对参数校验异常（IllegalArgumentException）的
 * 通用捕获逻辑误伤。</p>
 *
 * @author jay.wu
 */
...
public final class FlowBuildException extends RuntimeException {
    /** 聚合的全部构建问题诊断列表。 */
