...
if (!lines.any { it.contains("com.team4u:team4u-singleflight:jar") }) {
    failures.add("Missing direct runtime artifact: team4u-singleflight")
}
...
if (lines.any { it.contains("com.team4u:team4u-singleflight-proxy") ||
    ...
    failures.add("Singleflight proxy/spring adapters must not leak through team4u-singleflight")
}
if (lines.any { it.contains("com.team4u:team4u-proxy") }) {
    failures.add("team4u-proxy must not leak through team4u-singleflight")
}
if (lines.any { it.contains("org.springframework") }) {
    failures.add("Spring must not leak through team4u-singleflight")
}
